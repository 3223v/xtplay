  ...
  <div class="auth-page">
    <div class="auth-container fade-in-up">
      <div class="auth-header">
        ...
        <p class="auth-subtitle">登录你的 XTPlay 账号</p>
      </div>
...
.auth-page::before {
  ...
  width: 200%;
  height: 200%;
  background: radial-gradient(ellipse at 30% 50%, rgba(79, 70, 229, 0.04) 0%, transparent 50%),
              radial-gradient(ellipse at 70% 50%, rgba(129, 140, 248, 0.03) 0%, transparent 50%);
  pointer-events: none;
}
